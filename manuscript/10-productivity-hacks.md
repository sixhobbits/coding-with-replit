...
![**Image 1:** *Opening the command palette.*](https://codewithrepl.it/img/10-open-cmd-palette.png)
...
![**Image 11:** *Setting your keybinds to vim or emacs.*](https://codewithrepl.it/img/10-vim-emacs.png)
